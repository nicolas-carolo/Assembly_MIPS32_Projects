...
found_1:		beq		$t0, 0x20, found_2			# se la parola letta dal testo corrisponde a quella da cercare ($t0 = carattere 
										# di spaziatura),
...
p_none:			li		$v0, 4
			la		$a0, msg_none				# dopo aver mostrato il messaggio msg_none,
			syscall
			j		start					# cicla il programma chiedendo di inserire un'altra parola da cercare
